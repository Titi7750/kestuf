 ...
 */
final class Version20240416204418 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_event_favorite DROP FOREIGN KEY FK_45ACB85071F7E88B');
        $this->addSql('ALTER TABLE user_event_favorite DROP FOREIGN KEY FK_45ACB850A76ED395');
        $this->addSql('DROP TABLE user_event_favorite');
    }
}
